...
{
    public class UInt64Converter : IDataConverter
    {
        public DataFormat Format => DataFormat.UInt64;
        ...
        public string ConvertResponse(byte[] data, bool isBigEndian)
        {
            ...
            for (int i = 0; i < data.Length / 8; i++)
            {
                ...
                ulong v = isBigEndian ? BinaryPrimitives.ReadUInt64BigEndian(span) : BinaryPrimitives.ReadUInt64LittleEndian(span);
                if (i > 0) sb.Append(' ');
